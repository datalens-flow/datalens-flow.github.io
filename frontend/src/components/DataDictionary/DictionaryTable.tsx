...
interface DictionaryTableProps {
  table: any; // We can use proper type if available, fallback to any for now
  tableDesc: Record<string, string>;
  headerColor: string;
  isExpanded: boolean;
  tableSummary: string;
  toggleTableDesc: (id: string) => void;
  updateTableDescription: (id: string, desc: string) => void;
  updateDescription: (tableId: string, colName: string, desc: string) => void;
  dataClassifications: Record<string, Record<string, string>>;
  updateDataClassification: (tableId: string, colName: string, cls: string) => void;
}
